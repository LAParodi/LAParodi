# 🧙‍♂️ Acerca de mí:
<strong>Bachiller en Ingeniería de Software de la Universidad Tecnológica del Perú, con conocimiento en el desarrollo de sistemas y/o aplicaciones web, base de datos y metodologías ágiles. Cuento con 3 años de experiencia orientadas al desarrollo y diseño de sistemas y/o aplicaciones web, y con interés por desarrollarme profesionalmente en Análisis de Datos o Project Manager. Adicionalmente, poseo la facilidad de establecer una comunicación adecuada, amena y precisa hacía mis compañeros de trabajo sean de habla hispana o inglesa.</strong>
